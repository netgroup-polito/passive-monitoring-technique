...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']				
				Array10.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']		
				Array20.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']	
				Array30.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']	
				Array40.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']		
				Array50.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']			
				Array60.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']		
				Array70.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']		
				Array80.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']		
				Array90.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_nodes']		
				Array100.append(int(item[0]['info_clusters'][x]['num_extended_nodes']))
...
f=open('output_nodes_extended_Colt.txt','w')
sys.stdout=f
...
plt.ylabel('Number of nodes in the extended graph',fontsize=18)
plt.xlabel('Rate',fontsize=18)
plt.title('The relation between Rate and Number of nodes in the extended graph',fontsize=18)
plt.show()
