...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']				
				Array10.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']		
				Array20.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']	
				Array30.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']	
				Array40.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']		
				Array50.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']			
				Array60.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']		
				Array70.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']		
				Array80.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']		
				Array90.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['monitored_diameter']		
				Array100.append(int(item[0]['info_clusters'][x]['monitored_diameter']))
...
f=open('output_diameter_monitored_Colt.txt','w')
sys.stdout=f
...
plt.ylabel('Diameter in the monitored graph',fontsize=18)
plt.xlabel('Rate',fontsize=18)
plt.title('The relation between Rate and diameter in the monitored graph',fontsize=18)
plt.show()
