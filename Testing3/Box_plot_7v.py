...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']				
				Array10.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']		
				Array20.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']	
				Array30.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']	
				Array40.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']		
				Array50.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']			
				Array60.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']		
				Array70.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']		
				Array80.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']		
				Array90.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
for item in json_decode:
			...
			for x in range(len(item[0]['info_clusters'])):
				print "item x: ",item[0]['info_clusters'][x]['num_extended_edges']		
				Array100.append(int(item[0]['info_clusters'][x]['num_extended_edges']))
...
f=open('output_edges_extended_Colt.txt','w')
sys.stdout=f
...
plt.ylabel('Number of edges in the extended graph',fontsize=18)
plt.xlabel('Rate',fontsize=18)
plt.title('The relation between Rate and number of edges in the extended graph',fontsize=18)
plt.show()
