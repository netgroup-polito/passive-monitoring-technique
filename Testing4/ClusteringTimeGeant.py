...
input_file_10=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-10.json', 'r')
...
input_file_20=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-20.json', 'r')
...
input_file_30=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-30.json', 'r')
...
input_file_40=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-40.json', 'r')
...
input_file_50=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-50.json', 'r')
...
input_file_60=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-60.json', 'r')
...
input_file_70=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-70.json', 'r')
...
input_file_80=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-80.json', 'r')
...
input_file_90=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-90.json', 'r')
...
input_file_100=open('/home/federica/Desktop/20-11/Test_Clustering_Iter/Geant/Clusters-Iter-Geant2012-100.json', 'r')
json_decode=json.load(input_file_100)
for item in json_decode:
		Array100_t.append(float(item['Clustering_time']))
		Array100_n.append(int(item['Extended_graph_nodes']))
...
print "Monitored_Graph_Nodes : ",Nodes
...
with open("output_colonne_Geant_clustering_time.txt", "w") as f:
	sys.stdout=f
...
orig_stdout=sys.stdout
with open("output_Colonne_Geant_clusteringtime_polyfit.txt","w") as f1:
	sys.stdout=f1
...
plt.boxplot(Tot,positions=Nodes,widths=10)
plt.xlim(0,270)
